      ...
      <div className="mx-auto max-w-(--del-max-screen-width)">
        ...
        <div className="flex flex-col lg:flex-row lg:items-start lg:justify-between gap-6 sm:gap-8 lg:gap-16 mb-8 sm:mb-12 lg:mb-16">
          ...
          <motion.div
            ...
            className="lg:max-w-[481px] text-white text-base sm:text-lg leading-relaxed"
          >
            <p>
              Nigeria doesn&apos;t lack energy. It lacks the infrastructure and
              execution to <span className="font-bold">make it flow</span> to
              those who need it.
            </p>
            <p className="mt-3 sm:mt-4">
              DEL exists to make energy flow cleaner, reliably, and affordably
              to the people, businesses, and institutions that power
              Nigeria&apos;s future.
            </p>
          </motion.div>
        </div>
